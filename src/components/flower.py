...
class Flower(Entity):
    def __init__(self, x_pos, y_pos):
        ...
        self.image_tick = 0
        self.images = (
            pygame.image.load('assets/images/flower0.png').convert_alpha(),
            pygame.image.load('assets/images/flower1.png').convert_alpha(),
            pygame.image.load('assets/images/flower2.png').convert_alpha(),
            pygame.image.load('assets/images/flower3.png').convert_alpha()
        )
