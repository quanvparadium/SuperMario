...
from components.goombas import Goombas
from components.mushroom import Mushroom
from components.flower import Flower
from components.koopa import Koopa
from components.tube import Tube
from components.platformdebris import PlatformDebris
...
class Map(object):
    ...
    def loadWorld_11(self):
        ...
        #     print(self.id_map, type(self.id_map))
        #     print(os.path.join(os.getcwd(), f"assets/worlds/{self.id_map}/W{self.id_map.replace('-', '')}.tmx'"))
        #     print(os.path.exists(os.path.join(os.getcwd(), f"assets/worlds/{self.id_map}/W{self.id_map.replace('-', '')}.tmx'")))
        #     print(os.path.exists(f"./assets/worlds/{self.id_map}/W{self.id_map.replace('-', '')}.tmx'"))
            
        #     return
        # else: 
        #     print("ÁDJASDKASKDJASKDJASSSSSSSSSSSSSSSSSSSSSSSSSSS")
